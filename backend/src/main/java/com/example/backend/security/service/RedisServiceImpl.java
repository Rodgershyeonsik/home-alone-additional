...
public class RedisServiceImpl implements RedisService {
    ...
    public void setKeyAndValue(String token, Long memNo) {
        ...
        value.set(token, memNoToString, Duration.ofDays(1L));
    }
    ...
    public void deleteByKey(String token) { redisTemplate.delete(token); }

    public boolean isRefreshTokenExists(String token) { return getValueByKey(token) != null; }
}
